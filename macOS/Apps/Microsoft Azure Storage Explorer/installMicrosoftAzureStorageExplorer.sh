...
# Define variables
weburl="https://aka.ms/storageexplorer/downloadmacosarm64"                                   # What is the Azure Blob Storage URL?
appname="Microsoft Azure Storage Explorer"                                                   # The name of our App deployment script
app="Microsoft Azure Storage Explorer.app"                                                   # The actual name of our App once installed
logandmetadir="/Library/Logs/Microsoft/IntuneScripts/installMicrosoftAzureStorageExplorer"   # The location of our logs and last updated data
processpath="/Applications/Microsoft Azure Storage Explorer.app/Contents/MacOS/Electron"     # The process name of the App we are installing
